...
export class Api {
	...
	public Decks = new GenericApiService(this.http).setApiUrl(this.globalApiUrl + "/decks");
	public DeckCards = new GenericApiService(this.http).setApiUrl(this.globalApiUrl + "/deck-cards");
}
